...
/// @APIHOOK_START(EFST_ENUM)
	...
	//-- Job Bonus 
	EFST_novice_job_i = 2308,
	EFST_acolyte_job_i = 2309,
	EFST_archer_job_i = 2310,
	EFST_mage_job_i = 2311,
	EFST_merchant_job_i = 2312,
	EFST_sword_job_i = 2313,
	EFST_thief_job_i = 2314,

	//-- Job Others
	EFST_WOE_OLDTIMES = 2315,
	EFST_NOCOSTUMES = 2316,
	EFST_NOMASCOT = 2317,
	EFST_NOPALETTES = 2318,
	EFST_NOPETATTACK = 2319,
	EFST_PARTY_BUFFS = 2320,
	EFST_PET_LIFEINSURANCE = 2321,
	EFST_WORLDBOSS = 2322,
	EFST_DUNGEON_TEMP = 2323,
	EFST_CHEFFENIA_TEMP = 2324,
	EFST_DPS_CALCULATION = 2325,
	EFST_CHAR_COMPETITIVE = 2326,
	EFST_CELL_MVPNODAMAGE = 2327,
	EFST_ANTIBOT = 2328,
	EFST_DONTFORGETME1 = 2329,
	EFST_EVENT_DOUBLEEXP = 2330,
	EFST_ITEM_AUTOBONUS = 2331,
	EFST_MAP_ENHANCEMENT = 2332,
	
	//-- RESET
	EFST_CHAR_RESET_0 = 2500,
	EFST_CHAR_RESET_1 = 2501,
	EFST_CHAR_RESET_2 = 2502,
	EFST_CHAR_RESET_3 = 2503,
	EFST_CHAR_RESET_4 = 2504,
	EFST_CHAR_RESET_5 = 2505,
	EFST_CHAR_RESET_6 = 2506,
	EFST_CHAR_RESET_7 = 2507,
	EFST_CHAR_RESET_8 = 2508,
/// @APIHOOK_END
